...
- Issues in outdated app versions (please use the latest version)
...
| **Resolution target** | Critical: 7 days; High: 30 days; Medium: 90 days |
| **No legal action** | We will not pursue legal action against researchers who follow this policy in good faith |
| **Recognition** | Public acknowledgment with your consent (security hall of fame, future) |
...
- Share vulnerability details publicly before remediation
- Demand compensation as a condition of disclosure (we do not currently offer a bug bounty program)
