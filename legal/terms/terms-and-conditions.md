...
2. [Relationship to Other Agreements](#2-relationship-to-other-agreements)
3. [Platform Access Conditions](#3-platform-access-conditions)
4. [Service Availability](#4-service-availability)
5. [Geographic Scope](#5-geographic-scope)
6. [Account Conditions](#6-account-conditions)
7. [Fees and Payment Conditions](#7-fees-and-payment-conditions)
8. [Content Conditions](#8-content-conditions)
9. [Verification Conditions](#9-verification-conditions)
10. [Termination Conditions](#10-termination-conditions)
11. [Survival](#11-survival)
...
In the event of conflict between these Conditions and the Terms of Service, the Terms of Service prevail unless these Conditions expressly state otherwise for a specific matter.

These Conditions incorporate by reference:

- [Privacy Policy](../privacy/privacy-policy.md)
- [Marketplace Rules](../marketplace/marketplace-rules.md)
- [Seller Terms](../marketplace/seller-terms.md)
- [Subscription Terms](../premium/subscription-terms.md)
- All policies listed in the [Legal Index](../README.md)
...
- Third-party service outages (cloud hosting, maps, email)
- Force majeure events

We are not liable for temporary unavailability except as required by applicable consumer protection law.

---

## 5. Geographic Scope

MarGem is designed for users in **Morocco**. At launch, certain features may be limited to **Casablanca** and expand to additional cities over time.
...
- Users outside Morocco may access the Platform for informational purposes but certain features may be restricted

---

## 6. Account Conditions

### 6.1 One Account Per Person

Each individual should maintain only one personal account unless authorized for business purposes. Businesses may have designated representatives manage a seller account.
...
Email verification is required before accessing abuse-prone features including storefront creation, messaging, and submitting reviews.

### 6.4 Account Status

Accounts may be marked active, suspended, or deleted. Suspended accounts retain data subject to our retention policies but lose access to Platform features.
...
Basic Platform features are available at no charge, subject to these Conditions.
...
- [Subscription Terms](../premium/subscription-terms.md)
- [Refund Policy](../premium/refund-policy.md)
...
Prices may exclude applicable taxes. You are responsible for any taxes associated with your use of paid services.
...
- Violation of these Conditions or any incorporated policy
...
Upon termination, your right to access the Platform ceases. Provisions that by nature should survive (liability limitations, indemnification, dispute resolution) remain in effect.

---

## 11. Survival

The following survive termination: intellectual property provisions, disclaimers, limitation of liability, indemnification, dispute resolution, governing law, and any obligations accrued prior to termination.
