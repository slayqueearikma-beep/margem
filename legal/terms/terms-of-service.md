...
8. [Transactions Between Users](#8-transactions-between-users)
9. [Subscriptions and Premium Services](#9-subscriptions-and-premium-services)
10. [User Content and License](#10-user-content-and-license)
11. [Prohibited Conduct](#11-prohibited-conduct)
12. [Moderation and Enforcement](#12-moderation-and-enforcement)
...
20. [Changes to Terms](#20-changes-to-terms)
...
| **Premium Services** | Paid subscription features, including MarGem Plus (VIP) and Seller Pro (Premium). |
...
MarGem is primarily designed for users in **Morocco**. Features may initially be limited to specific cities (e.g., Casablanca). We may expand geographic availability over time.
...
To access certain features, you must create an account with a valid email address and password. You may register as a buyer, seller, or both on a single account.
...
Certain features (storefront creation, messaging, reviews) require a verified email address.
...
Sellers may create storefronts, publish listings, receive inquiries, and access analytics. Sellers are subject to additional terms in our [Seller Terms](../marketplace/seller-terms.md) and [Business Listing Policy](../marketplace/business-listing-policy.md).

### 6.3 Guests

Guests may browse and search without an account. Guest data (e.g., local favorites) is stored on the device and may be migrated upon registration.
...
- Reviews and ratings
- In-app messaging and contact tools (call, WhatsApp, email, SMS, website)
- Business verification (subject to our verification policies)
- Reporting and moderation tools
- Premium subscription features
- Administrative and trust & safety services

We may add, modify, or discontinue features at any time with reasonable notice where practicable.
...
| Plan | Price | Benefits |
|------|-------|----------|
| **MarGem Plus** (VIP) | 49 MAD / 30 days | Saved search sync, personalized recommendations, priority support, early access to featured listings |
| **Seller Pro** (Premium) | 199 MAD / 30 days | Featured placement, premium badge, advanced analytics, extra media uploads, verification priority |

Subscription terms, billing, cancellation, and refunds are governed by our [Subscription Terms](../premium/subscription-terms.md), [VIP Membership Terms](../premium/vip-membership-terms.md), [Premium Membership Terms](../premium/premium-membership-terms.md), and [Refund Policy](../premium/refund-policy.md).
...
User Content must comply with our [Acceptable Use Policy](../terms/acceptable-use-policy.md), [Community Guidelines](../terms/community-guidelines.md), [Prohibited Content Policy](../trust-safety/prohibited-content-policy.md), and [User Generated Content Policy](../marketplace/user-generated-content-policy.md).

### 10.3 Content Removal

We may remove or restrict User Content that violates our policies or applicable law, with or without notice.
...
- Engage in spam, scraping, or automated access without authorization
- Harass, threaten, or harm other users
- Upload malware or attempt to compromise Platform security
- Circumvent verification, moderation, or access controls
- Use the Platform for illegal products, dangerous services, or prohibited content

See our [Acceptable Use Policy](../terms/acceptable-use-policy.md) and [Fraud Prevention Policy](../trust-safety/fraud-prevention-policy.md) for complete details.
...
See our [Content Moderation Policy](../trust-safety/content-moderation-policy.md) and [Trust & Safety Policy](../trust-safety/trust-safety-policy.md). Users may appeal certain decisions as described in those policies.
...
The Platform integrates with third-party services (maps, messaging apps, email, cloud hosting). Your use of third-party services is governed by their terms. See our [Third-Party Services Disclosure](../privacy/third-party-services.md).
...
These Terms are governed by the laws of the **Kingdom of Morocco**, without regard to conflict of law principles. See [Governing Law](../terms/governing-law.md).

---

## 20. Changes to Terms

We may modify these Terms at any time. Material changes will be communicated via the Platform or email. Continued use after changes constitutes acceptance.
...
*These Terms incorporate by reference all policies listed in the [Legal Index](../README.md).*
