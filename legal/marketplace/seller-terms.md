...
2. [Seller Eligibility](#2-seller-eligibility)
3. [Storefront and Listings](#3-storefront-and-listings)
4. [Verification](#4-verification)
5. [Premium Seller Features](#5-premium-seller-features)
6. [Buyer Interactions](#6-buyer-interactions)
7. [Reviews and Reputation](#7-reviews-and-reputation)
8. [Fees and Subscriptions](#8-fees-and-subscriptions)
9. [Taxes and Legal Compliance](#9-taxes-and-legal-compliance)
10. [Prohibited Seller Conduct](#10-prohibited-seller-conduct)
...
- Operate a legitimate business or provide legitimate services in Morocco
- Provide accurate business information
- Comply with all applicable laws, licenses, and permits

---

## 3. Storefront and Listings

### 3.1 Storefront Information

You are responsible for maintaining accurate:

- Business name, description, and category
- Address, city, and location coordinates
- Contact details (phone, WhatsApp, website, social media)
- Opening hours, service areas, and delivery options
- Logo, cover image, and business media

### 3.2 Product and Service Listings

Each listing must comply with our [Business Listing Policy](business-listing-policy.md):

- Accurate titles, descriptions, and pricing (MAD)
- High-quality, original images and media
- Correct category and availability status
...
## 5. Premium Seller Features

**Seller Pro** (199 MAD / 30 days) includes:

- Featured placement in discovery results
- Premium badge on storefront
- Advanced analytics (profile views, inquiries, contact clicks, response time)
- Additional media upload capacity
- Verification priority in review queue

Premium features are subject to [Premium Membership Terms](../premium/premium-membership-terms.md) and [Subscription Terms](../premium/subscription-terms.md).

---

## 6. Buyer Interactions
...
- Refunds and returns (per your policies and applicable law)
...
- Business registration and licensing in Morocco
- Tax obligations (VAT, income tax, etc.)
...
## 10. Prohibited Seller Conduct

Sellers must not:

- List counterfeit, stolen, or illegal products
- Misrepresent business location, credentials, or verification status
...
- Certain data may be retained per our [Data Retention Policy](../privacy/data-retention-policy.md)

You may delete your account at any time via [Account Deletion Policy](../privacy/account-deletion-policy.md).
