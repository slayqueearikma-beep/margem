...
Enterprise arrangements may include:

| Service | Description |
|---------|-------------|
| **Enhanced visibility** | Custom featured placement and discovery priority |
...
Specific services are defined in each Enterprise Agreement.

---

## 3. Enterprise vs. Seller Pro

| Feature | Seller Pro | Enterprise |
|---------|-----------|------------|
| Self-serve signup | Yes | No — contact sales |
| Pricing | 199 MAD / 30 days | Custom |
| Contract | Subscription Terms | Enterprise Agreement |
| Support | Priority | Dedicated |
| Custom features | No | Negotiated |
...
Enterprise customers are subject to our [Privacy Policy](../privacy/privacy-policy.md). Additional data processing terms may be included in Enterprise Agreements (e.g., data processing addendum for GDPR compliance).

---

## 6. Termination

Enterprise Agreements specify termination terms. Upon termination, enterprise features are deactivated and the account reverts to standard seller terms.
