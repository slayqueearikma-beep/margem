...
## 2. Features That May Appear AI-Related

The following features use **rule-based logic**, not AI:
...
3. Provide opt-out mechanisms where required by law
4. Update our [Privacy Policy](privacy-policy.md) with AI-specific data processing details
5. Notify users of material changes before deployment
...
- Discovery ranking based on subscription status and listing metadata
- Analytics aggregation

These processes do not produce legal or similarly significant effects on users.
