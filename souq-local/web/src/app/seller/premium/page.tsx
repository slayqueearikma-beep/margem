  ...
  return (
    <div className="mx-auto max-w-xl space-y-4 rounded-3xl border border-[var(--border)] bg-white p-6">
      ...
      <p className="text-[var(--muted)]">
        DriverPro unlocks up to 20 combined listings, featured placement, and an ad-free seller experience for 149 DH.
      </p>
      <p className="text-sm text-[var(--muted)]">
        Subscription checkout is handled in the Dribex mobile app today. Sign in on mobile, open Premium, and choose DriverPro.
      </p>
